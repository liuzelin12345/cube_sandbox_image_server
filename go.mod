module github.com/TencentCloudAgentRuntime/ags-cookbook/examples/custom-image-go-sdk/cube_sandbox_image_server
...
require (
	...
	github.com/zeromicro/go-zero/tools/goctl v1.10.1 // indirect
