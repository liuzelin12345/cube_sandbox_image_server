...
// 查询腾讯云自定义沙箱工具状态
func GetSandboxToolStatusHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetSandboxToolStatusRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := cubeSandboxImage.NewGetSandboxToolStatusLogic(r.Context(), svcCtx)
		resp, err := l.GetSandboxToolStatus(&req)
		if err != nil {
